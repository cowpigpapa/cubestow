...
const CTU_NOTICE='모든 화물의 안쪽·좌·우가 막히는 배치를 찾느라 계산이 20~40초 걸릴 수 있고, 컨테이너가 늘 수 있습니다. 이 모드는 CTU Code의 배치 규칙을 적용한 검토용 결과이며 준수를 보증하지 않습니다. 화물 강도·마찰·래싱 용량은 현장에서 따로 확인하세요.';
